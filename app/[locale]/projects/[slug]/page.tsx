...
export default async function ProjectDetailPage({ params }: Props) {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative flex flex-col justify-center -top-16 pt-16 pb-4 sm:pt-0 sm:pb-0 h-100 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          {project.shortDescription && (
            <p className="sm:text-xl text-gray-200 mt-4 max-w-2xl">
              {project.shortDescription}
            </p>
          )}
        </div>
