...
export function Header() {
  ...
  const bgClass = scrolled
    ? "bg-black/90 backdrop-blur-sm transition-colors duration-300 ease-in-out"
  ...
  return (
    <motion.header
      className={`sticky top-0 z-50  ${bgClass}`}
    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <Link
              href={pathname}
              locale={otherLocale}
              className="flex items-center gap-1 text-sm font-semibold text-white hover:text-yellow-400 transition-colors"
            >
            ...
            <button
              className="md:hidden p-2 relative z-[60] text-white"
      ...
      {/* Mobile Navigation with Animated Background */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="md:hidden fixed inset-0 bg-gradient-to-br from-black via-neutral-900 to-black z-40"
            />
